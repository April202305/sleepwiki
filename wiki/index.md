...
- [[review/03-慢波干预-3.1-P1-证据包|3.1-P1 证据包]]：锁相听觉刺激的原理与范式演进受限草案及逐句证据矩阵。`review`｜2026-08-18｜10 来源
...
- [[review/03-慢波干预-3.1-文献需求单|第 3.1 节文献需求单]]：锁相听觉刺激从开放环到相位/响应依赖控制的证据需求与 6 项下载任务。`review`｜2026-08-18｜6 份准入背景来源
- [[review/全章节文献需求总览|全章节文献需求总览]]：按 25 个正式小标题导航全部独立文献需求单及统一下载清单。`review`｜2026-08-18｜需求导航
- [[review/01-引言-1.1-文献需求单|第 1.1 节文献需求单]]：疾病负担与临床需求的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/01-引言-1.4-文献需求单|第 1.4 节文献需求单]]：综述范围与结构安排的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/03-慢波干预-3.2-文献需求单|第 3.2 节文献需求单]]：慢波与纺锤波生理证据的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/03-慢波干预-3.3-文献需求单|第 3.3 节文献需求单]]：记忆与认知疗效争议的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/03-慢波干预-3.4-文献需求单|第 3.4 节文献需求单]]：临床队列研究的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/04-全周期-4.1-文献需求单|第 4.1 节文献需求单]]：入睡期干预的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/04-全周期-4.2-文献需求单|第 4.2 节文献需求单]]：纺锤波与运动记忆的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/04-全周期-4.3-文献需求单|第 4.3 节文献需求单]]：REM 干预与 TMR的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/04-全周期-4.4-文献需求单|第 4.4 节文献需求单]]：梦境调控的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/04-全周期-4.5-文献需求单|第 4.5 节文献需求单]]：觉醒保护与自适应的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/05-系统形态-5.1-文献需求单|第 5.1 节文献需求单]]：听觉刺激的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/05-系统形态-5.2-文献需求单|第 5.2 节文献需求单]]：电刺激与磁刺激的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/05-系统形态-5.3-文献需求单|第 5.3 节文献需求单]]：光振动温度等模态的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/05-系统形态-5.4-文献需求单|第 5.4 节文献需求单]]：系统对比与居家产品化的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/06-挑战展望-6.1-文献需求单|第 6.1 节文献需求单]]：生理—行为因果链的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/06-挑战展望-6.2-文献需求单|第 6.2 节文献需求单]]：个体差异与适配的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/06-挑战展望-6.3-文献需求单|第 6.3 节文献需求单]]：相位精度与延迟瓶颈的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/06-挑战展望-6.4-文献需求单|第 6.4 节文献需求单]]：长期安全与结构扰动的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
- [[review/06-挑战展望-6.5-文献需求单|第 6.5 节文献需求单]]：真实世界与标准评测的独立证据需求、下载任务与放行边界。`review`｜2026-08-18｜需求页
