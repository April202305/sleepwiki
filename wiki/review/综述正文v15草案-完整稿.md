...
本文采用结构化叙述性综述方法，围绕闭环睡眠干预的“感知—识别与决策—刺激—反馈—验证”链路开展检索。2026年8月13—15日检索 PubMed、OpenAlex、Scopus、Semantic Scholar 和 ClinicalTrials.gov，并通过已纳入研究、相关综述及章节文献需求清单进行引文追溯和定向补充。检索词围绕“sleep”“wearable EEG”“sleep staging”“closed-loop stimulation”“slow oscillation”“sleep spindle”“phase estimation”“real-time”“latency”“home”等组合。中文专项检索计划包括中国知网、万方、SinoMed 和维普，但目前尚未形成完整的中文数据库命中与筛选记录。

检索设置六条主题线，分别覆盖闭环架构与时延、慢波锁相听觉刺激、入睡期与 REM 等全周期干预、刺激模态与系统形态、个体化与长期安全，以及可穿戴 EEG 与 PSG 验证。六条检索线合计得到786条线内去重记录，全局去重后为647篇，另检出223项注册临床试验。由于同一文献可能命中多条检索线，各主题线数量不作直接相加。当前正式稿引用107条文献，但该数量包括指南、综述、算法与设备研究、人体干预研究、会议论文、预印本、动物研究和邻近工程文献，不等同于系统综述意义上的最终纳入数量。

纳入研究需直接支撑睡眠信号质量、在线状态或事件识别、相位估计、刺激触发、系统时延、生理响应、行为或临床结局、安全性及居家实施中的至少一个环节。排除缺乏睡眠相关终点、仅有离线结果且不能支撑闭环链路、仅报告产品宣传，或无法核验方法和题录的资料。预印本仅用于补充最新探索性进展；会议论文主要用于算法与工程实现；动物研究仅用于机制或风险提示；非睡眠工程研究仅作为同步、标定和失效保护的邻近参照，均不用于直接推断人体临床疗效。

文献经跨平台去重、题名与摘要初筛、全文核验后，提取研究人群、设备与信号、参考标准、运行模式、算法因果性、刺激参数、分项时延、生理与行为终点、安全性和失败夜处理等信息。综合时区分信号质量、在线识别、刺激命中、生理效应、行为或临床获益及长期安全等证据层级，避免以离线准确率替代在线性能，或以瞬时脑电响应替代临床疗效。由于尚未完成双人独立筛选、统一偏倚风险评价和完整 PRISMA 排除流程，本文定位为结构化叙述性综述，而非系统综述或荟萃分析。
