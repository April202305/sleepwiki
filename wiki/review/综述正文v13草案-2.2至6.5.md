---
type: review
aliases: ["综述正文 v13（2.2–6.5）"]
created: 2026-08-20
updated: 2026-08-20
sources: ["[[review/睡眠BCI闭环干预综述_逐节写作逻辑大纲 (1)]]", "[[review/证据矩阵]]", "[[review/证据包/README|证据包目录]]", "[[review/研究主归属与跨章节重复控制表]]", "[[review/综述正文v12草案-2.2至6.5]]", "[[review/邻近技术证据一致性审计与复用规则]]"]
...
本稿完整继承[[review/综述正文v12草案-2.2至6.5]]的正文、3.2四层改写、证据边界、研究主归属、跨章节去重及全部待补项，仅依据[[review/邻近技术证据一致性审计与复用规则]]统一五类邻近技术证据的叙述层级；其余正文原样继承。本稿为待确认版本，不自动并入[[review/综述正文草案]]，也不自动同步TeX。
...
外加tACS相位同步rTMS锁定的是预设电刺激波形，而不是由实时EEG慢波反馈更新刺激，因此只作为邻近技术证据；5.2据此仅保留“真正EEG反馈闭环TMS仍缺直接证据”的边界。[[source-pages/takahashi-2026-phase-synchronized-rtms-tacs]]（PDF第6–16页）对核心电刺激研究，同步EEG的刺激伪影、盲区、重新触发条件、可重复性、耐受性和长期安全仍需独立报告。证据包：[[review/证据包/05-系统形态-5.2-P1-证据包]]。
...
视觉—声学比较中，声音增加 0.5–3 Hz 活动，红光未出现相应效应。[[source-pages/danilenko-2020-visual-vs-acoustic]]（PDF 第 1、5–10 页）开放环温控床罩只作为邻近技术证据：它不参与闭环模态疗效排名，本节仅据此保留睡眠状态反馈温控仍为`gap`的边界。[[source-pages/stevenson-2025-temperature-mattress]]（PDF第1、4–17页）多模态联合需要单模态、联合与sham因子对照，确认增益来自控制互补。证据包：[[review/证据包/05-系统形态-5.3-P1-证据包]]。
...
> **邻近技术证据与适用边界**
>
> 无EEG双向Mamba、非睡眠Thalamus、开放环温控床罩、外加tACS锁相rTMS和以醒后报告反馈的Dormio只提供局部技术参照，不与上述EEG睡眠闭环人体系统处于同一叙述层级。本框统一登记其邻近证据角色；相关章节只保留与本章问题直接相关的一处边界性引用，不重复完整样本、协议和结果数字，五项研究均不进入核心横向表。[[source-pages/zhang-2026-mamba-wearable-staging]]；[[source-pages/haggerty-2026-thalamus]]；[[source-pages/stevenson-2025-temperature-mattress]]；[[source-pages/takahashi-2026-phase-synchronized-rtms-tacs]]；[[source-pages/haar-horowitz-2020-dormio]]
...
- 本版本完整继承[[review/综述正文v12草案-2.2至6.5]]的正文范围、2.2结构、2.3受限放行、3.2四层改写、4.3路径B、5.4核心系统横向比较、证据边界及全部仍适用的待补项；本轮只统一五类邻近技术证据的叙述层级。
