...
# Pathak 等（2021）：闭环刺激降低环境噪声诱发觉醒

## 基本信息
- 类型：人体夜间实验预印本
- 原始文件：`raw/inbox/pathak-2021-looping-lullaby.pdf`
- source_id：`raw/inbox/pathak-2021-looping-lullaby.pdf`
- 作者/年份：Vidushi Pathak 等；2021
...
研究先测个体噪声觉醒阈值，再比较环境噪声夜与同时使用模型驱动闭环声刺激的干预夜；干预夜由噪声引起的觉醒概率下降。[[intervention/闭环听觉刺激]]（预印本 PDF 第 3–4、7–13 页，Figures 1–4）

## 方法与发现
- 该方案用于提高对后续环境噪声的耐受性，不等同于通用的“检测到觉醒即停止”规则，也不是按上一刺激反应在线更新剂量的二级反馈。

## 关联词条
- 干预：[[intervention/闭环听觉刺激]]
- 综述：[[review/文献清单/04-全周期-4.5-文献需求单]]、[[review/证据矩阵]]

## 局限与待核实
- ⚠️预印本；需与刺激本身造成的觉醒、自然环境长期效果分开解释。

## 来源
- `raw/inbox/pathak-2021-looping-lullaby.pdf`
