...
# Bressler 等（2024）：alpha 反相声刺激缩短入睡潜伏期试验

## 基本信息
- 类型：居家、多夜、随机交叉对照试验
- 原始文件：`raw/inbox/bressler-2024-alpha-phase-insomnia-rct.pdf`
- source_id：`raw/inbox/bressler-2024-alpha-phase-insomnia-rct.pdf`
- 作者/年份：Scott Bressler 等；2024
- 英文原题：A randomized controlled trial of alpha phase-locked auditory stimulation to treat symptoms of sleep onset insomnia
...
21 名客观入睡潜伏期延长的成人完成居家随机交叉试验。刺激周在夜初 30 分钟以三通道额区 EEG 头带递送 alpha 反相声音，sham 周仅记录；盲法 EEG 评分的周平均入睡潜伏期减少 10.5±15.9 分钟，混合模型 p=0.0019。[[device/Elemind Neuromodulation Device]]（PDF 第 1–4、7–9 页，Figures 1–3）

## 方法与发现
- 试验含两夜 sham run-in、每条件四夜及洗脱期；终点是短期客观入睡潜伏期，不是长期失眠缓解或与药物的头对头比较。
- 作者与设备开发公司存在机构关联，应在质量评价中保留。

## 关联词条
- 设备：[[device/Elemind Neuromodulation Device]]
- 综述：[[review/文献清单/04-全周期-4.1-文献需求单]]、[[review/证据包/04-全周期-4.1-P1-证据包]]、[[review/证据矩阵]]

## 局限与待核实
- ⚠️样本小、随访短；“可替代药物”属于作者讨论，试验没有直接比较药物。

## 来源
- `raw/inbox/bressler-2024-alpha-phase-insomnia-rct.pdf`
