---
type: source
aliases: ["Baldassarri 2026 ecological CLAS"]
created: 2026-08-18
updated: 2026-08-22
sources: ["raw/inbox/baldassarri-2026-clas-memory-ecological.pdf"]
review_sections: ["6.1", "6.5"]
status: active
review_due: 2027-08-18
---

# Baldassarri 等（2026）：生态居家 CLAS 的生理与记忆结果

## 基本信息
- 类型：居家、组间对照研究
- 原始文件/source_id：`raw/inbox/baldassarri-2026-clas-memory-ecological.pdf`
- 作者/年份：Baldassarri 等；2026
- 英文原题：The Effect of Closed-Loop Auditory Stimulation on Memory Consolidation and Sleep Physiology in an Ecological Setting
- review_sections：["6.1", "6.5"]
...
## 局限与待核实
- ⚠️非随机顺序分组、受试者不能完全盲法、小样本且设备佩戴存在变异；阴性行为结果不能证明绝对无效。

## 关联词条
- 综述：[[review/文献清单/06-挑战展望-6.1-文献需求单]]、[[review/证据包/06-挑战展望-6.1-P1-证据包]]、[[review/证据矩阵]]

## 来源
- `raw/inbox/baldassarri-2026-clas-memory-ecological.pdf`
